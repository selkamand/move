...
[![CRAN status](https://www.r-pkg.org/badges/version/move)](https://CRAN.R-project.org/package=move)
<!-- badges: end -->

> [!WARNING]  
> This package is in early development and not yet ready for use

The move R package provides functions for basic 3d & multidimensional transformation of points, vectors, and planes.
